...
numbertosimulate  <- 2000
newOut1 <- simulateSurvivaltimesWithCensoringCovariate(fitCensor,
                                                       plpData,
                                                       TrainingSet$Train$labels,
                                                       populationSettings,
                                                       numbertosimulate,
                                                       8003 )
newOut2 <- simulateSurvivaltimesWithCensoringCovariate(fitCensor,
                                                       plpData,
                                                       TrainingSet$Train$labels,
                                                       populationSettings,
                                                       numbertosimulate,
                                                       9003 )
newOut3 <- simulateSurvivaltimesWithCensoringCovariate(fitCensor,
                                                       plpData,
                                                       TrainingSet$Train$labels,
                                                       populationSettings,
                                                       numbertosimulate,
...
ggplot2::ggplot()+
  KaplanMeierPlot( newOut1, colour = 'red')+
  KaplanMeierPlot( newOut2, colour = 'orange')+
  KaplanMeierPlot( newOut3, colour = 'yellow')+
